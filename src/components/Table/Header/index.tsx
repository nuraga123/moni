...
const Header: React.FC = () => {
  ...
  return (
    <thead className="text-[#a1a1aa]">
      <tr className="flex h-[52px] py-[17px] relative">
        <th className="text-muted flex mr-2 text-left pl-4  w-[158px] sticky left-0 z-20 bg-[#111112]">
          {headers[0].name}
        </th>

        <th className="text-muted flex mr-2 px-3 w-[82px] z-0">
          <SortArrow />
          {headers[1].name}
        </th>

        <th className="text-muted flex mr-2 pl-[27px] w-[80px] z-0">
          <SortArrow />
          {headers[2].name}
        </th>
